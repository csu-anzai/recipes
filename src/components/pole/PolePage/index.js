...
const Pole = () => {
  const [video, setVideo] = useState(jp_cooper_birthday);
  ...
  return (
    <div className="Pole">
      ...
      <p>below are some videos of the routines I have learnt</p>
      <br />
      ...
      <div className="routineButtons">
        <div
          ...
          onClick={() => setVideo(cruel_youth_devil_in_paradise)}
        >
          Cruel Youth - Devil In Paradise
        </div>
        <div
          className="routineButton"
          onClick={() => setVideo(ludovico_einaudi_i_giorni)}
        >
          Ludovico Einuaudi - I Giorni
        </div>
        <div
          className="routineButton"
          onClick={() => setVideo(annie_lennox_i_put_a_spell_on_you)}
        >
          Annie Lenox - I Put A Spell On You
        </div>
        <div className="routineButton" onClick={() => setVideo(her_focus)}>
          H.E.R. - Focus
        </div>
        <div
          className="routineButton"
          onClick={() => setVideo(sereda_i_got_you)}
        >
          Sereda - I Got You
        </div>
        <div
          className="routineButton"
          onClick={() => setVideo(jp_cooper_birthday)}
        >
          JP Cooper - Birthday
        </div>
      </div>
